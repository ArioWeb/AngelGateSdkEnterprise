...
public class DeleteFileJob extends ContextJob {

    private static final String TAG = DeleteFileJob.class.getSimpleName();
    ...
    public DeleteFileJob(Context context, WorkerParameters workerParams ) {
    ...
    public static Data.Builder constructData(String handler, String deviceId) {
        Data.Builder dataBuilder = new Data.Builder()
                .putString(DeleteFileJob.KEY_handler, handler)
                .putString(DeleteFileJob.KEY_deviceId, deviceId);
    ...
    public Result onRun() throws IOException {
        ...
        Call<ResponseBody> callback = MainActivity.apiInterface2.DeleteFile(TimeStamp, DeviceId, segment, Ssalt, Request, isArrayRequest, handlerObject);
        ...
        if (response.body() != null && response.isSuccessful()) {
            ...
            System.out.println("testJob" + "onRun fail" + t.code());
