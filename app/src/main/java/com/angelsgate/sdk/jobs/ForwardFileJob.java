...
public class ForwardFileJob extends ContextJob {

    private static final String TAG = ForwardFileJob.class.getSimpleName();
    ...
    public ForwardFileJob(Context context, WorkerParameters workerParams ) {
    ...
    public static Data.Builder constructData(String handler,String peer ,String deviceId) {
        Data.Builder dataBuilder = new Data.Builder()
                .putString(ForwardFileJob.KEY_handler, handler)
                .putString(ForwardFileJob.KEY_peer, peer)
                .putString(ForwardFileJob.KEY_deviceId, deviceId);
    ...
    public Result onRun() throws IOException {
        ...
        String peer = data.getString(KEY_peer);
        ...
        final String Request = "DeleteFile";
        boolean isArrayRequest = false;
        final String DeviceId = deviceId;

        HandlerObject handlerObject = new HandlerObject(handler);

        Call<ResponseBody> callback = MainActivity.apiInterface2.ForwardFile(TimeStamp, DeviceId, segment, Ssalt, Request, isArrayRequest, handlerObject,peer);
    ...
    public static boolean LocalErrorHandler(String respose) {
        ...
        switch (respose) {
            ...
            case "ERROR_FILE_NOTCOMPLETED":
                return false;


            case "ERROR_FILE_WRONGPEER":
                return false;
