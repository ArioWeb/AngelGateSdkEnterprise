...
public class CheckFileWSJob extends ContextJob {

    private CountDownLatch completeSignal = new CountDownLatch(1);

    private static final String TAG = CheckFileWSJob.class.getSimpleName();
    ...
    ///////////////////////////////
    public CheckFileWSJob(Context context, WorkerParameters workerParams) {
    ...
    public static Data.Builder constructData(String handler, String deviceId) {
        Data.Builder dataBuilder = new Data.Builder()
                .putString(CheckFileWSJob.KEY_handler, handler)
                .putString(CheckFileWSJob.KEY_deviceId, deviceId);
    ...
    @Override
    public Result onRun() throws IOException, GeneralSecurityException {
                    ...
                    if (AngelsGate.StringErroreHandler(bodyResponse)) {
                        ...
                        if (AngelsGate.ErroreHandler(data_response)) {
                            ...
                            if (LocalErrorHandler(data_response)) {
                                ...
                                Data ErrorData1 = ApiError("خطای عمومی1");
                                return Result.failure(ErrorData1);
                            }


                        } else {
                            Data ErrorData1 = ApiError("خطای عمومی2");
                            return Result.failure(ErrorData1);
                        }

                    } else {
                        Data ErrorData1 = ApiError("خطای عمومی3");
                        return Result.failure(ErrorData1);
    ...
    public void onCreatSessionEvent(CheckFileEvent event) {
