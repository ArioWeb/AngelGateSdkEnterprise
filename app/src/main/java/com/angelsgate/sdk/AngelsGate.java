...
public class AngelsGate {
    ...
    public static Request EncodeRequest(Request OkHttpRequest, long timestamp, String deviceId, int Segment, String Ssalt, String nameMethode, boolean isArrayResponse, Context ctx) throws UnsupportedEncodingException, GeneralSecurityException {
