...
public class Base64Utils {
    ...
    public synchronized static byte[] Base64DecodeToByteForDownload(String message) {
    ...
    public static String toBase64(String message) {
        ...
        try {
            ...
            byte[] result= EncodeAlgorithmUtils.Deflate(data);


            String base64Sms = Base64.encodeToString(result, Base64.NO_WRAP);
            return base64Sms;
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
